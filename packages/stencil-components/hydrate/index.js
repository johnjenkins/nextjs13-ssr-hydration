...
/*!
 Stencil Mock Doc v2.22.5 | MIT Licensed | https://stenciljs.com
 */
...
function componentOnReady() {
 var e;
 return null === (e = getHostRef(this)) || void 0 === e ? void 0 : e.$onReadyPromise$;
}

function forceUpdate() {}

function hydrateApp(e, t, n, o, s) {
 function r() {
  if (global.clearTimeout(m), a.clear(), i.clear(), !h) {
   ...
   try {
    ...
    renderCatchError(t, n, e);
   }
  }
  o(e, t, n, s);
 }
 function l(e) {
  renderCatchError(t, n, e), r();
 }
 ...
 try {
   ...
   if (isValidComponent(e, t) && !getHostRef(e)) {
    ...
    function n(e, t) {
     ...
     null != t.$members$) {
      ...
      Object.entries(t.$members$).forEach((([o, s]) => {
       const r = s[0];
       if (31 & r) {
        const l = s[1] || o, i = e.getAttribute(l);
        if (null != i) {
         const e = parsePropertyValue(i, r);
         n.$instanceValues$.set(o, e);
        }
        const a = e[o];
        void 0 !== a && (n.$instanceValues$.set(o, a), delete e[o]), 0 == (2048 & r) ? Object.defineProperty(e, o, {
         get() {
         ...
         get() {
          ...
          return (null == e ? void 0 : e.$lazyInstance$) ? e.$lazyInstance$[o] : void 0;
         },
         configurable: !0,
         enumerable: !0
        }), 4096 & r && Object.defineProperty(e, o, {
         set(e) {
          const n = getHostRef(this);
          if (!n) return;
          const s = (s = !1) => {
           n.$lazyInstance$ && (n.$lazyInstance$[o] = e), setValue(this, o, e, t, !s);
          };
          n.$lazyInstance$ ? s() : n.$onInstancePromise$ && n.$onInstancePromise$.then((() => s(!0)));
         }
        }));
       } else 64 & r && Object.defineProperty(e, o, {
        value(...t) {
         const n = getHostRef(this);
         if (!n) throw "no hostRef found";
         return n.$onInstancePromise$.then((() => {
          if (!n.$lazyInstance$) throw "no $lazyInstance on hostRef";
          n.$lazyInstance$[o](...t);
         })).catch((t => consoleError(t, e)));
        }
       });
      }));
     }
  ...
  function g(o) {
   return a.delete(o), isValidComponent(o, t) && n.hydratedCount < t.maxHydrateCount && !i.has(o) && shouldHydrate(o) ? (i.add(o), 
   async function s(e, t, n, o, r) {
    ...
    if (null != l && null != l.cmpMeta) {
     r.add(o);
     try {
      connectedCallback(o), await o.componentOnReady(), t.hydratedCount++;
      const e = getHostRef(o), s = e.$modeName$ ? e.$modeName$ : "$";
      t.components.some((e => e.tag === n && e.mode === s)) || t.components.push({
       tag: n,
       mode: s,
       count: 0,
       depth: -1
   ...
   }(e, n, o.nodeName, o, d)) : p;
  }
  e.document.createElement = function t(n) {
   const o = c.call(e.document, n);
   return u(o), o;
  }, e.document.createElementNS = function t(n, o) {
   const s = $.call(e.document, n, o);
   return u(s), s;
  ...
  function e(t) {
   if (null != t && 1 === t.nodeType) {
    u(t);
    const n = t.children;
    for (let t = 0, o = n.length; t < o; t++) e(n[t]);
   }
...
function isValidComponent(e, t) {
 if (null != e && 1 === e.nodeType) {
  const n = e.nodeName;
  if ("string" == typeof n && n.includes("-")) return !t.excludeComponents.includes(n.toLowerCase());
 }
 return !1;
}
...
function renderCatchError(e, t, n) {
 const o = {
  level: "error",
  type: "build",
 ...
 if (e.url) try {
  ...
  "/" !== t.pathname && (o.header += ": " + t.pathname);
 } catch (e) {}
 null != n && (null != n.stack ? o.messageText = n.stack.toString() : null != n.message ? o.messageText = n.message.toString() : o.messageText = n.toString()), 
 t.diagnostics.push(o);
}

function printTag(e) {
 let t = `<${e.nodeName.toLowerCase()}`;
 if (Array.isArray(e.attributes)) for (let n = 0; n < e.attributes.length; n++) {
...
function waitingOnElementMsg(e) {
 ...
 if (e) {
  ...
  t = " - waiting on:";
  let o = e;
  for (;o && 9 !== o.nodeType && "BODY" !== o.nodeName; ) n.unshift(printTag(o)), 
  o = o.parentElement;
  let s = "";
  for (const e of n) s += "  ", t += `\n${s}${e}`;
 }
 return t;
}
...
const createTime = (e, t = "") => {
 return () => {};
}, EMPTY_OBJ = {}, isComplexType = e => "object" == (e = typeof e) || "function" === e, isPromise = e => !!e && ("object" == typeof e || "function" == typeof e) && "function" == typeof e.then, h = (e, t, ...n) => {
 let o = null, r = null, l = !1, i = !1;
 const a = [], d = t => {
  for (let n = 0; n < t.length; n++) o = t[n], Array.isArray(o) ? d(o) : null != o && "boolean" != typeof o && ((l = "function" != typeof e && !isComplexType(o)) ? o = String(o) : BUILD.isDev  , 
  l && i ? a[a.length - 1].$text$ += o : a.push(l ? newVNode(null, o) : o), i = l);
 };
 if (d(n), t && (t.name && (r = t.name), BUILD.vdomClass)) {
 ...
 return (n.$attrs$ = null), (n.$name$ = null), n;
 ...
 t;
}, renderSlotFallbackContent = (e, t) => {
 if (!e["s-hsf"] || !e.parentNode) return;
 let n, o = e.parentNode.__childNodes || e.parentNode.childNodes;
 const s = o.length;
 let r = 0;
 ...
 for (o = 0, s = t.length; o < s; o++) {
  if (t[o]["s-sr"]) for (l = t[o]["s-sn"], n = t[o], renderSlotFallbackContent(n, !1), 
  r = 0; r < s; r++) if (i = t[r].nodeType, !t[r]["s-sf"]) if (t[r]["s-hn"] !== n["s-hn"] || "" !== l) {
   if (1 === i && l === t[r]["s-sn"]) {
    renderSlotFallbackContent(n, !0), patchRemove(t[r]);
    break;
   }
  ...
  updateFallbackSlotVisibility(t[o]);
 }
}, patchNextSibling = e => {
 if (!e || e.__nextSibling) return;
 const t = Object.getOwnPropertyDescriptor(Node.prototype, "nextSibling");
 t ? Object.defineProperty(e, "__nextSibling", t) : e.__nextSibling = e.nextSibling || !0, 
 Object.defineProperty(e, "nextSibling", {
  get: function() {
   var e;
   const t = null === (e = this["s-ol"]) || void 0 === e ? void 0 : e.parentNode.childNodes, n = null == t ? void 0 : t.indexOf(this);
   return t && n > -1 ? t[n + 1] : this.__nextSibling;
  }
 });
}, patchNextElementSibling = e => {
 if (!e || e.__nextElementSibling || !e.nextSiblingElement) return;
 const t = Object.getOwnPropertyDescriptor(Element.prototype, "nextElementSibling");
 t ? Object.defineProperty(e, "__nextElementSibling", t) : e.__nextElementSibling = e.nextSiblingElement || !0, 
 Object.defineProperty(e, "nextElementSibling", {
  get: function() {
   var e;
   const t = null === (e = this["s-ol"]) || void 0 === e ? void 0 : e.parentNode.children, n = null == t ? void 0 : t.indexOf(this);
   return t && n > -1 ? t[n + 1] : this.__nextElementSibling;
  }
 });
}, patchPreviousSibling = e => {
 if (!e || e.__previousSibling) return;
 const t = Object.getOwnPropertyDescriptor(Node.prototype, "previousSibling");
 t ? Object.defineProperty(e, "__previousSibling", t) : e.__previousSibling = e.previousSibling || !0, 
 Object.defineProperty(e, "previousSibling", {
  get: function() {
   var e;
   const t = null === (e = this["s-ol"]) || void 0 === e ? void 0 : e.parentNode.childNodes, n = null == t ? void 0 : t.indexOf(this);
   return t && n > -1 ? t[n - 1] : this.__previousSibling;
  }
 });
}, patchPreviousElementSibling = e => {
 if (!e || e.__previousElementSibling || !e.previousElementSibling) return;
 const t = Object.getOwnPropertyDescriptor(Element.prototype, "previousElementSibling");
 t ? Object.defineProperty(e, "__previousElementSibling", t) : e.__previousElementSibling = e.previousSiblingElement || !0, 
 Object.defineProperty(e, "previousElementSibling", {
  get: function() {
   var e;
   const t = null === (e = this["s-ol"]) || void 0 === e ? void 0 : e.parentNode.children, n = null == t ? void 0 : t.indexOf(this);
   return t && n > -1 ? t[n - 1] : this.__previousElementSibling;
  }
 });
}, patchRemove = e => {
...
}, addSlotRelocateNode = (e, t) => {
 if (e["s-ol"] && e["s-ol"].isConnected) return;
 const n = document.createTextNode("");
 n["s-nr"] = e, t["s-cr"] && t["s-cr"].parentNode && (t["s-cr"].parentNode.__appendChild || t["s-cr"].parentNode.appendChild).call(t["s-cr"].parentNode, n), 
 e["s-ol"] = n;
}, getHostSlotNode = (e, t) => {
 let n, o = 0;
 if (!e) return null;
 ...
 if (1 === r.nodeType) {
  if (a = r.getAttribute("c-id"), a && (d = a.split("."), d[0] === l || "0" === d[0])) {
   ...
   if (i) {
    ...
    const e = n.find((e => e.$elm$["s-sn"] === c.$elm$["s-sn"] || e.$name$ === c.$elm$["s-sn"]));
   ...
   p && (r["s-si"] = p), e = c, o && "0" === c.$depth$ && !i && (o[c.$index$] = c.$elm$);
  }
  const m = r.__childNodes || r.childNodes;
  for ($ = m.length - 1; $ >= 0; $--) clientHydrate(e, t, n, o, s, m[$], l, i);
  if (r.shadowRoot) for ($ = r.shadowRoot.childNodes.length - 1; $ >= 0; $--) clientHydrate(e, t, n, o, s, r.shadowRoot.childNodes[$], l, i);
  ...
  if (d = r.nodeValue.split("."), d[1] === l || "0" === d[1]) if (a = d[0], c = createSimpleVNode({
   ...
   if (o) {
    ...
    addSlottedNodes(i, d[2], s, r, c.$hostId$), r.remove(), "0" === c.$depth$ && (o[c.$index$] = c.$elm$);
   } else {
    const n = c.$elm$, o = l && l !== c.$hostId$ && e.$elm$.shadowRoot;
    addSlottedNodes(i, d[2], s, r, o ? l : c.$hostId$), o && e.$elm$.insertBefore(n, e.$elm$.children[0]), 
    t.push(c);
   }
   n.push(c), e.$children$ || (e.$children$ = []), e.$children$[c.$index$] = c;
  } else "r" === a && (o ? r.remove() : (s["s-cr"] = r, 
  r["s-cn"] = !0));
 ...
 if (1 === e.nodeType) {
  const n = e["s-id"] || e.getAttribute("s-id");
  n && t.set(n, e);
  let o = 0;
  const s = e.__childNodes || e.childNodes;
  for (;o < s.length; o++) initializeDocumentHydrate(s[o], t);
  ...
  "o" === n[0] && (t.set(n[1] + "." + n[2], e), e["s-en"] = n[3]);
 }
}, createSimpleVNode = e => ({
 $flags$: 0,
 $hostId$: null,
 ...
 $text$: null,
 ...e
}), addSlottedNodes = (e, t, n, o, s) => {
 let r = o.nextSibling;
 for (e[t] = e[t] || []; r && (r["s-sn"] === n || "" === n && !r["s-sn"] && (8 === r.nodeType && 1 !== r.nodeValue.indexOf(".") || 3 === r.nodeType)) && !r["s-sf"]; ) r["s-sn"] = n, 
 e[t].push({
  slot: o,
  node: r,
  hostId: s
 }), r = r.nextSibling;
}, parsePropertyValue = (e, t) => null == e || isComplexType(e) ? e : 1 & t ? String(e) : e, emitEvent = (e, t, n) => {
 const o = plt.ce(t, n);
 return e.dispatchEvent(o), o;
}, rootAppliedStyles = new WeakMap, registerStyle = (e, t, n) => {
 let o = styles.get(e);
 o = t, styles.set(e, o);
}, addStyle = (e, t, n, o) => {
 var s;
 ...
 if (e = 11 === e.nodeType ? e : doc, l) if ("string" == typeof l) {
  e = e.head || e;
  let n, i = rootAppliedStyles.get(e);
  if (i || rootAppliedStyles.set(e, i = new Set), !i.has(r)) {
   if (e.host && (n = e.querySelector(`[sty-id="${r}"]`))) n.innerHTML = l; else {
    n = doc.createElement("style"), n.innerHTML = l;
    const a = null !== (s = plt.$nonce$) && void 0 !== s ? s : queryNonceMetaTagContent(doc);
    null != a && n.setAttribute("nonce", a), n.setAttribute("sty-id", r), 
 ...
 const t = e.$cmpMeta$, n = e.$hostElement$, o = t.$flags$, s = createTime("attachStyles", t.$tagName$), r = addStyle(n.getRootNode(), t);
 10 & o && (n["s-sc"] = r, 
 n.classList.add(r + "-h"), BUILD.scoped  ), 
 s();
}, getScopeId = (e, t) => "sc-" + (e.$tagName$), setAccessor = (e, t, n, o, s, r) => {
 if (n !== o) {
  isMemberInElement(e, t); t.toLowerCase();
  if ("class" === t) {
   const t = e.classList, s = parseClassList(n), r = parseClassList(o);
   e["s-si"] && r.indexOf(e["s-si"]) < 0 && r.push(e["s-si"]), t.remove(...s.filter((e => e && !r.includes(e)))), 
   t.add(...r.filter((e => e && !s.includes(e))));
  }
 }
}, parseClassListRegex = /\s/, parseClassList = e => e ? e.split(parseClassListRegex) : [], updateElement = (e, t, n, o) => {
 const s = 11 === t.$elm$.nodeType && t.$elm$.host ? t.$elm$.host : t.$elm$, r = e && e.$attrs$ || EMPTY_OBJ, l = t.$attrs$ || EMPTY_OBJ;
 for (o in r) o in l || setAccessor(s, o, r[o], void 0);
 for (o in l) setAccessor(s, o, r[o], l[o]);
};

let scopeId, contentRef, hostTagName, useNativeShadowDom = !1, checkSlotFallbackVisibility = !1, checkSlotRelocate = !1;

const createElm = (e, t, n, o) => {
 const s = t.$children$[n];
 let r, l, i, a = 0;
 if (!useNativeShadowDom && (checkSlotRelocate = !0, "slot" === s.$tag$ && (scopeId && o.classList.add(scopeId + "-s"), 
 ...
 if ((r["s-hn"] = hostTagName, 3 & s.$flags$)) {
  ...
  i = e && e.$children$ && e.$children$[n], i && i.$tag$ === s.$tag$ && e.$elm$ && putBackInOriginalLocation(e.$elm$, !1);
 }
 return r;
 ...
 plt.$flags$ &= -2;
}, addVnodes = (e, t, n, o, s, r) => {
 let l, i = e["s-cr"] && e["s-cr"].parentNode || e;
 for (i.shadowRoot && i.tagName === hostTagName && (i = i.shadowRoot); s <= r; ++s) o[s] && (l = createElm(null, n, s, e), 
 l && (o[s].$elm$ = l, i.insertBefore(l, referenceNode(t) )));
}, saveSlottedNodes = e => {
 const t = e.__childNodes || e.childNodes;
 let n, o, s;
 for (o = 0, s = t.length; o < s; o++) n = t[o], n["s-ol"] ? n["s-hn"] && (n["s-hn"] = void 0) : saveSlottedNodes(n);
}, removeVnodes = (e, t, n, o, s) => {
 for (;t <= n; ++t) (o = e[t]) && (s = o.$elm$, (checkSlotFallbackVisibility = !0, 
 saveSlottedNodes(s), s["s-ol"] ? s["s-ol"].remove() : putBackInOriginalLocation(s, !0)), 
 s.remove());
 ...
 const n = t.$elm$ = e.$elm$, o = e.$children$, s = t.$children$, r = t.$tag$, l = t.$text$;
 let i;
 null !== l ? (i = n["s-cr"]) ? i.parentNode.textContent = l : e.$text$ !== l && (n.textContent = l, 
 n["s-sf"] && (n["s-sfc"] = l)) : (("slot" === r || updateElement(e, t)), 
 null !== o && null !== s ? ((e, t, n, o) => {
  const s = [], r = {};
  let l, a, d, c, $, p, m, h, f = 0, u = 0, y = 0, L = 0, I = t.length - 1, D = t[0], b = t[I], v = o.length - 1, N = o[0], U = o[v];
  for (;f <= I && u <= v; ) if (null == D) D = t[++f]; else if (null == b) b = t[--I]; else if (null == N) N = o[++u]; else if (null == U) U = o[--v]; else if (isSameVnode(D, N)) patch(D, N), 
  D = t[++f], N = o[++u]; else if (isSameVnode(b, U)) patch(b, U), b = t[--I], U = o[--v]; else if (isSameVnode(D, U)) "slot" !== D.$tag$ && "slot" !== U.$tag$ || putBackInOriginalLocation(D.$elm$.parentNode, !1), 
  patch(D, U), e.insertBefore(D.$elm$, b.$elm$.nextSibling), D = t[++f], U = o[--v]; else if (isSameVnode(b, N)) "slot" !== D.$tag$ && "slot" !== U.$tag$ || putBackInOriginalLocation(b.$elm$.parentNode, !1), 
  patch(b, N), e.insertBefore(b.$elm$, D.$elm$), b = t[--I], N = o[++u]; else {
   (l = createElm(t && t[u], n, u, e), N = o[++u]), 
   l && (parentReferenceNode(D.$elm$).insertBefore(l, referenceNode(D.$elm$)) );
  }
  if (f > I ? addVnodes(e, null == o[v + 1] ? null : o[v + 1].$elm$, n, o, u, v) : u > v && removeVnodes(t, f, I), 
  e.parentNode && n.$elm$["s-hsf"]) {
 ...
 })(n, o, t, s) : null !== s ? (null !== e.$text$ && (n.textContent = ""), 
 addVnodes(n, null, t, s, 0, s.length - 1)) : null !== o && removeVnodes(o, 0, o.length - 1), 
 BUILD.svg   );
}, relocateNodes = [], relocateSlotContent = e => {
 let t, n, o, s, r, l, i = 0;
 const a = e.__childNodes || e.childNodes, d = a.length;
 for (;i < d; i++) {
  if (t = a[i], t["s-sr"] && (n = t["s-cr"]) && n.parentNode) for (t["s-hsf"] && (checkSlotFallbackVisibility = !0), 
  o = n.parentNode.__childNodes || n.parentNode.childNodes, s = t["s-sn"], l = o.length - 1; l >= 0; l--) n = o[l], 
  n["s-cn"] || n["s-nr"] || n["s-hn"] === t["s-hn"] || (isNodeLocatedInSlot(n, s) ? (r = relocateNodes.find((e => e.$nodeToRelocate$ === n)), 
  checkSlotFallbackVisibility = !0, n["s-sn"] = n["s-sn"] || s, r ? r.$slotRefNode$ = t : relocateNodes.push({
   $slotRefNode$: t,
   $nodeToRelocate$: n
  }), n["s-sr"] && relocateNodes.map((e => {
   isNodeLocatedInSlot(e.$nodeToRelocate$, n["s-sn"]) && (r = relocateNodes.find((e => e.$nodeToRelocate$ === n)), 
   r && !e.$slotRefNode$ && (e.$slotRefNode$ = r.$slotRefNode$));
  }))) : relocateNodes.some((e => e.$nodeToRelocate$ === n)) || relocateNodes.push({
   $nodeToRelocate$: n
  }));
 ...
 const n = e.$hostElement$, s = e.$vnode$ || newVNode(null, null), r = isHost(t) ? t : h(null, null, t);
 if (hostTagName = n.tagName, BUILD.isDev  ) ;
 if (r.$tag$ = null, r.$flags$ |= 4, e.$vnode$ = r, r.$elm$ = s.$elm$ = n.shadowRoot || n, 
 ...
 BUILD.slotRelocation) {
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   t["s-ol"] || (n = originalLocationDebugNode(t) , 
   n["s-nr"] = t, t.parentNode.insertBefore(t["s-ol"] = n, t));
   for (a = 0; a < relocateNodes.length; a++) if (e = relocateNodes[a], t = e.$nodeToRelocate$, 
   e.$slotRefNode$) {
    for (o = e.$slotRefNode$.parentNode, s = e.$slotRefNode$.__nextSibling || e.$slotRefNode$.nextSibling, 
    n = t["s-ol"], i = s; n = n.__previousSibling || n.previousSibling; ) if (l = n["s-nr"], 
    l && l["s-sn"] === t["s-sn"] && o === l.parentNode && (l = l.__nextSibling || l.nextSibling, 
    !l || !l["s-nr"])) {
     s = l;
     break;
    }
    (!s && o !== t.parentNode || (t.__nextSibling || t.nextSibling) !== s) && (t !== s ? (!t["s-hn"] && t["s-ol"] && (t["s-hn"] = t["s-ol"].parentNode.nodeName), 
    o.insertBefore(t, s), t.hidden = !1) : o.insertBefore(t, i));
 ...
 const n = () => dispatchHooks(e, t);
 return writeTask(n) ;
}, dispatchHooks = (e, t) => {
 const o = createTime("scheduleUpdate", e.$cmpMeta$.$tagName$), s = e.$lazyInstance$ ;
 let r;
 return o(), then(r, (() => updateComponent(e, s, t)));
}, updateComponent = async (e, t, n) => {
 const o = e.$hostElement$, s = createTime("update", e.$cmpMeta$.$tagName$), r = o["s-rc"];
 n && attachStyles(e);
 const l = createTime("render", e.$cmpMeta$.$tagName$);
 if (await callRender(e, t) , 
 BUILD.hydrateServerSide) try {
  serverSideConnected(o), n && (1 & e.$cmpMeta$.$flags$ ? o["s-en"] = "" : 2 & e.$cmpMeta$.$flags$ && (o["s-en"] = "c"));
 } catch (e) {
  consoleError(e, o);
 }
 if (r && (r.map((e => e())), o["s-rc"] = void 0), l(), s(), 
 BUILD.asyncLoading) {
  const t = o["s-p"], n = () => postUpdateComponent(e);
  0 === t.length ? n() : (Promise.all(t).then(n), e.$flags$ |= 4, t.length = 0);
 }
};

const callRender = (e, t, n) => {
 try {
 ...
 const t = e.$cmpMeta$.$tagName$, n = e.$hostElement$, o = createTime("postUpdate", t), r = e.$ancestorComponent$;
 64 & e.$flags$ ? (o()) : (e.$flags$ |= 64, addHydratedFlag(n), 
 o(), (e.$onReadyResolve$(n), r || appDidLoad())), (e.$onRenderResolve$ && (e.$onRenderResolve$(), 
...
}, getValue = (e, t) => getHostRef(e).$instanceValues$.get(t), setValue = (e, t, n, o, s = !0) => {
 const r = getHostRef(e), i = r.$instanceValues$.get(t), a = r.$flags$, d = r.$lazyInstance$ ;
 n = parsePropertyValue(n, o.$members$[t][0]);
 const c = Number.isNaN(i) && Number.isNaN(n), $ = n !== i && !c;
 if ((!(8 & a) || void 0 === i) && $ && (r.$instanceValues$.set(t, n), 
 d)) {
  if (2 == (18 & a)) {
   scheduleUpdate(r, !1);
  }
 ...
 if (t.$members$) {
  ...
  if (o.map((([e, [o]]) => {
   if ((31 & o || (2 & n) && 32 & o)) {
    if (0 == (2048 & o) ? Object.defineProperty(s, e, {
     get() {
     ...
     configurable: !0,
     enumerable: !0
    }) : 1 & n && 2048 & o && BUILD.lazyLoad && Object.defineProperty(s, e, {
     get() {
      const t = getHostRef(this), n = t ? t.$lazyInstance$ : s;
      if (n) return n[e];
     },
     configurable: !0,
     enumerable: !0
    }), 4096 & o) {
     const n = Object.getOwnPropertyDescriptor(s, e).set;
     Object.defineProperty(s, e, {
      set(o) {
       const r = getHostRef(this);
       if (n) return n.apply(this, [ o ]), void setValue(this, e, r.$hostElement$[e], t);
       if (!r) return;
       const l = (n = !1) => {
        r.$lazyInstance$[e] = o, setValue(this, e, r.$lazyInstance$[e], t, !n);
       };
       r.$lazyInstance$ ? l() : r.$onInstancePromise$.then((() => l(!0)));
      }
     });
    }
   }
   ...
   s.attributeChangedCallback = function(e, t, o) {
    plt.jmp((() => {
     ...
     r.get && !r.set || (this[t] = (null !== o || "boolean" != typeof this[t]) && o);
    }));
 ...
 return e;
}, initializeComponent = async (e, t, n, o, s) => {
 if (0 == (32 & t.$flags$)) {
  {
   if (t.$flags$ |= 32, (s = loadModule(n)).then) {
    const e = (() => {});
    s = await s, e();
   }
   !s.isProxied && (proxyComponent(s, n, 2), s.isProxied = !0);
   const o = createTime("createInstance", n.$tagName$);
   (t.$flags$ |= 8);
   try {
    new s(t);
   } catch (t) {
  ...
  if (s.style) {
   let o = s.style;
   const r = getScopeId(n);
   if (!styles.has(r)) {
    const e = createTime("registerStyles", n.$tagName$);
    registerStyle(r, o), e();
   }
  }
 }
...
}, fireConnectedCallback = (e, t) => {
}, connectedCallback = e => {
 if (0 == (1 & plt.$flags$)) {
  const t = getHostRef(e), n = t.$cmpMeta$, o = createTime("connectedCallback", n.$tagName$);
  if (1 & t.$flags$) ; else {
   let o;
   if (t.$flags$ |= 1, (o = e.getAttribute("s-id"), o)) {
    ((e, t, n, o) => {
     const s = createTime("hydrateClient", t), r = e.shadowRoot, l = [], i = [], a = r ? [] : null;
     let d = newVNode(t, null);
     d.$elm$ = e, plt.$orgLocNodes$ || initializeDocumentHydrate(doc.body, plt.$orgLocNodes$ = new Map), 
     e["s-id"] = n, e.removeAttribute("s-id"), o.$vnode$ = clientHydrate(d, l, [], a, e, e, n, i);
     let c = 0;
     const $ = l.length;
     let p;
     for (;c < $; c++) {
      p = l[c];
      const n = p.$hostId$ + "." + p.$nodeId$, o = plt.$orgLocNodes$.get(n), s = p.$elm$;
      r || (s["s-hn"] = t.toUpperCase(), "slot" === p.$tag$ && (s["s-cr"] = e["s-cr"])), 
      o && o.isConnected && (r && "" === o["s-en"] && o.parentNode.insertBefore(s, o.nextSibling), 
      o.parentNode.removeChild(o)), plt.$orgLocNodes$.delete(n);
     }
     const m = [];
     let h = 0;
     const f = i.length;
     ...
     for (;h < f; h++) if (u = i[h], u && u.length) for (y = u.length, g = 0; g < y; g++) {
      ...
      if (!e.shadowRoot || !r) {
       ...
       addSlotRelocateNode(L.node, L.slot), (I = L.node) && !I.__nextSibling && globalThis.Node && (patchNextSibling(I), 
       patchPreviousSibling(I), patchNextElementSibling(I), patchPreviousElementSibling(I));
      }
      e.shadowRoot && e.appendChild(L.node);
     }
     var I;
     if (r) {
      let t = 0;
      const n = a.length;
      for (;t < n; t++) r.appendChild(a[t]);
   ...
   if (!o && (BUILD.hydrateServerSide ) && setContentReference(e), 
   BUILD.asyncLoading) {
    let n = e;
    for (;n = n.parentNode || n.host; ) if (1 === n.nodeType && n.hasAttribute("s-id") && n["s-p"] || n["s-p"]) {
     attachToAncestor(t, t.$ancestorComponent$ = n);
     break;
    }
   }
 ...
 t["s-cn"] = !0, e.firstChild ? e.insertBefore(t, e.firstChild) : e.appendChild(t);
 ...
 if (null != e) {
  ...
  parseVNodeAnnotations(e, e.body, n, o), o.forEach((t => {
   if (null != t) {
    const o = t["s-nr"];
    let s = o["s-host-id"], r = o["s-node-id"], l = `${s}.${r}`;
    if (null == s) if (s = 0, n.rootLevelIds++, r = n.rootLevelIds, l = `${s}.${r}`, 
    1 === o.nodeType) o.setAttribute("c-id", l), "string" == typeof o["s-sn"] && o.setAttribute("s-sn", o["s-sn"]); else if (3 === o.nodeType) {
     if (0 === s && "" === o.nodeValue.trim()) return void t.remove();
     const n = e.createComment(l);
     n.nodeValue = `t.${l}`, o.parentNode.insertBefore(n, o);
    }
    let i = `o.${l}`;
 ...
 null != t && (null != t["s-nr"] && o.push(t), 1 === t.nodeType && t.childNodes.forEach((t => {
  ...
  if (null != s && !n.staticComponents.has(t.nodeName.toLowerCase())) {
   ...
   insertVNodeAnnotations(e, t, s.$vnode$, n, o);
  }
  parseVNodeAnnotations(e, t, n, o);
 })));
 ...
 if (null != n) {
  ...
  null != n.$children$) {
   const t = 0;
   n.$children$.forEach(((n, o) => {
    insertChildVNodeAnnotations(e, n, s, r, t, o);
   }));
  }
  if (t && n && n.$elm$ && !t.hasAttribute("c-id")) {
   const e = t.parentElement;
   if (e && e.childNodes) {
    const o = Array.from(e.childNodes), s = o.find((e => 8 === e.nodeType && e["s-sr"]));
    if (s) {
     const e = o.indexOf(t) - 1;
     n.$elm$.setAttribute("c-id", `${s["s-host-id"]}.${s["s-node-id"]}.0.${e}`);
    }
   }
  }
 }
}, insertChildVNodeAnnotations = (e, t, n, o, s, r) => {
 var l;
 const i = t.$elm$;
 if (null == i) return;
 const a = n.nodeIds++, d = `${o}.${a}.${s}.${r}`;
 if (i["s-host-id"] = o, i["s-node-id"] = a, 1 === i.nodeType) i.setAttribute("c-id", d), 
 "string" == typeof i["s-sn"] && i.setAttribute("s-sn", i["s-sn"]); else if (3 === i.nodeType) {
  const t = i.parentNode, n = t.nodeName;
  if ("STYLE" !== n && "SCRIPT" !== n) {
   const n = i["s-sn"] || "", o = `t.${d}.${i["s-sf"] ? "1" : "0"}.${n}`, s = e.createComment(o);
   t.insertBefore(s, i);
  }
 } else if (8 === i.nodeType && i["s-sr"]) {
  const n = i["s-sn"] || "", o = null === (l = t.$children$) || void 0 === l ? void 0 : l.filter((e => {
   var t;
   return 3 === (null === (t = e.$elm$) || void 0 === t ? void 0 : t.nodeType);
  })).map((e => (e.$elm$["s-sf"] = !0, e.$text$))).join(" "), s = `s.${d}.${n}.${i["s-hsf"] ? "1" : "0"}.${i["s-sfc"] || o ? "1" : "0"}`;
  if (i.nodeValue = s, i["s-sfc"] || o) {
   const t = i.parentNode, n = e.createComment(i["s-sfc"] || o);
   t.insertBefore(n, i);
  }
 ...
 if (null != t.$children$) {
  ...
  t.$children$.forEach(((t, s) => {
   insertChildVNodeAnnotations(e, t, n, o, r, s);
  }));
 }
}, hAsync = (e, t, ...n) => {
 if (Array.isArray(n) && n.length > 0) {
  const o = n.flat(1 / 0);
  return o.some(isPromise) ? Promise.all(o).then((n => h(e, t, ...n))).catch((n => h(e, t))) : h(e, t, ...n);
 }
 return h(e, t);
...
const cmpModules = new Map, getModule = e => {
 ...
 return null;
}, loadModule = (e, t, n) => getModule(e.$tagName$), isMemberInElement = (e, t) => {
 if (null != e) {
  if (t in e) return !0;
  const n = getModule(e.nodeName);
  if (null != n) {
   const e = n;
 ...
 return n.$onInstancePromise$ = new Promise((e => n.$onInstanceResolve$ = e)), n.$onReadyPromise$ = new Promise((e => n.$onReadyResolve$ = e)), 
 e["s-p"] = [], e["s-rc"] = [], hostRefs.set(e, n);
}, styles = new Map;
...
const myTextComponentCss = "/*!@:host*/.sc-my-text-component-h{display:var(--display, inline-block)}/*!@:host(.text-block)*/.text-block.sc-my-text-component-h{display:var(--display, block)}/*!@.text*/.text.sc-my-text-component{margin:var(--margin, 10px);padding:var(--padding, 10px);display:var(--display);color:inherit;font-size:72px;font-weight:inherit;line-height:var(--line-height, 1)}";
